 ...
 * (default window: 2026-06-01 .. 2026-07-06 — edit t0/t1 if your anchor dates change) by a fixed day delta.
 * Usage: node scripts/shift-gpx-trip-dates.cjs [deltaDays]
 * Example (May 20 start vs Jun 1): node scripts/shift-gpx-trip-dates.cjs -12
 */
const fs = require("fs");
...
// Standalone YYYY-MM-DD in prose (e.g. "Date: 2026-06-01" newline) — word boundaries work.
